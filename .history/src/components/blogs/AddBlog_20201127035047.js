        ...
        return (
            <form className = "container" style = {{ marginTop : "20px"}} onSubmit = {this.submitForm}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" onChange = {this.formValueChange} value = {this.state.name}/>
                </div>
                <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" class="form-control" id="username" onChange = {this.formValueChange} value = {this.state.username}/>
                </div>
                <div class="form-group">
